...
//     }
 ...
 LifecycleCallbackReturn OffboardControl::on_configure(const rclcpp_lifecycle::State &previous_state)
     ...
     * @return SUCCESS se ativado corretamente
     *
     * Responsabilidades:
     * - Ativar o publisher
     ...
     *
     * @param previous_state Estado anterior
     * @return SUCCESS se desativado corretamente
     *
     * Responsabilidades:
     * - Parar o timer
...
//     }
     ...
     *
     * @param previous_state Estado anterior
     * @return SUCCESS se encerrado corretamente
     *
     * Responsabilidades:
    ...
    /**
     * @brief Callback chamado quando ocorre um erro no nó.
     *
     * @param previous_state Estado anterior
     * @return FAILURE indicando falha no nó
     *
     * Responsabilidades:
     * - Limpar recursos
